        ...
        <div className="Box-pages">
            <ul className="Box-list">
                <li className="Box-text">
                    <Link to="/Home" className='Box-link'>Home</Link>
                </li>
                <li className="Box-text">
            ...
            <form className="Callback">
                ...
                <div className="Callback-box">
                    <div className="Callback-email">
                        <label className="Callback-label" for="email">Email</label>
                    ...
                    <div className="Callback-name">
                        <label className="Callback-label" for="text">Name</label>
                        <div className="Callback-name__error" id='error2'>This field is required</div>
                        <Input id="name" name="text" type="text" placeholder="Enter your name" />
                    </div>
                    <div className="Callback-radio">
                        ...
                        <div className="Callback-man">
                            ...
                            <label className="Callback-man__label" for="radio-1">Man</label>
                        </div>
                        <div className="Callback-woman">
                            <input className="Callback-woman__input" id="radio-2" type="radio" name="gender" value="woman"></input>
                            <label className="Callback-woman__label" for="radio-2">Woman</label>
                        </div>
                    </div>
                    <div className="Callback-text">
                        <label className="Callback-text__label" for="textarea">Comment</label>
                    ...
                    <div className="Callback-checkbox">
                        ...
                        <label className="Callback-checkbox__label" for="checkbox-1">I agree to receive updates by email</label>
                    </div>
